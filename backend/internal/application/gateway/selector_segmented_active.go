...
func segmentedCandidateCohorts(values []account.RoutingCandidate, indexes []int, now time.Time, tierGroups account.WebTierGroups, preferFreeBuild bool, windowOptions ...int) []segmentedSelectorCohortBucket {
