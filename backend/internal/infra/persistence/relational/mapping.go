...
func toAccountDomain(value accountModel) account.Credential {
	...
	return account.Credential{
		...
		MaxConcurrent: value.MaxConcurrent, MaxConcurrentManaged: value.MaxConcurrentManaged, MinimumRemaining: value.MinimumRemaining, FailureCount: value.FailureCount,
