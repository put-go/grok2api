...
func TestModelsUseExpectedTierGroups(t *testing.T) {
	...
	tests := []struct {
		...
		{model: "grok-imagine-image", want: account.WebTierGroups{{account.WebTierBasic}, {account.WebTierSuper, account.WebTierHeavy}}},
		{model: "grok-imagine-image-quality", want: account.WebTierGroups{{account.WebTierBasic}, {account.WebTierSuper, account.WebTierHeavy}}},
		{model: "imagine-image-edit", want: account.WebTierGroups{{account.WebTierBasic}, {account.WebTierSuper, account.WebTierHeavy}}},
		{model: "grok-imagine-video", want: account.WebTierGroups{{account.WebTierBasic}, {account.WebTierSuper, account.WebTierHeavy}}},
